    ...
    return (
        <div className="h-screen bg-gradient-to-tr">
                ...
                <div className="flex justify-center pt-4 mt-5 row">
                    <div className="shadow-xl card bg-accent/30">
                        <p className="text-3xl">
                            My name is Nate Mills! Full stack web developer with a passion for tech and learning new frameworks. Proficient in JavaScript,
                            TypeScript, React, Express, SQL and Node. I'm focused on finding solutions to complex problems, and creating impactful software.
                        </p>
                    </div>
                </div>
                <ExperienceComponent />
            ...
            <div
                ...
                id="projects"
            >
                <h1 className="p-10 text-6xl text-info"> Check out some of these Projects!</h1>
